...
///
///            Batimento Cardíaco com Oxímetro
/// Amostragem de sinal cardíaco e transmissão de batimentos po minuto
...
volatile unsigned int enable=0, T0=0, T1=0; // Verificam início e final do pulso cardíaco
volatile unsigned int period_in = 0, period_out = 0, bpm = 0; // Calculam período do pulso
